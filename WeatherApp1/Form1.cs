...
namespace WeatherApp1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string uri = string.Format("http://api.weatherapi.com/v1/forecast.xml?key=47f0af27061f4d77a2c103806212503&q={0}&days=1&aqi=no&alerts=no", city);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string uri = string.Format("http://api.weatherapi.com/v1/forecast.xml?key=47f0af27061f4d77a2c103806212503&q={0}&days=10&aqi=no&alerts=no", city);
